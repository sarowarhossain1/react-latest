...
const [isYearly, setIsYearly] = useState(false);
  return (
    <div>
      <div className={dark ? "dark font-inter" : "font-inter"}>
       ...
       <h2 className="text-xl font-bold mx-55 mt-20 text-[#F94049] ">GET STARTED</h2>

      <div className="flex justify-between items-center mt-1">
        <h3 className={`text-4xl font-bold font-serif mx-55 ${dark ? "text-4xl font-bold font-serif mx-55 text-black" : "text-4xl font-bold font-serif mx-55 text-black" }`}>Simple pricing. No surprises.</h3>
        <div className="flex justify-center mt-10 me-55">
      <div className="flex items-center bg-[#F2F0E9] px-6 py-3   gap-6">
        <span
          onClick={() => setIsYearly(false)}
          className={`cursor-pointer font-bold font-serif text-2xl
      ...
      <div className={`grid grid-cols-1 md:grid-cols-4 m-10 md:w-[1350px] bg-[#FFFFFF] mx-auto ${dark  ? "text-black " : "text-black"
        ...
        <div className="shadow-2xl w-full h-full p-10 rounded-xl">
            <h3 className="text-center font-sans  text-2xl font-semibold mb-5">STANDARD</h3>
            <p className="text-center text-2xl font-mono font-bold mb-3">$ 29</p>
            <p className="text-center text-xl  font-semibold">per organization / month 
              billed annually</p>
              <div className='mt-6'>
                  <button className='bg-[#FFE4DE] px-18 border border-[#D32C3E] py-3 text-xl rounded font-bold hover:bg-[#D32C3E] hover:text-white text-[#D32C3E] mb-8'>  Get Started</button>
                </div>
      ...
      <div className="shadow-2xl w-full h-full p-10 rounded-xl">
            <h3 className="text-center font-sans  text-2xl font-semibold mb-5">PROFESSIONAL</h3>
        ...
        <div className="relative shadow-2xl w-full h-full p-10  bg-black">
          <div className="absolute -top-1 right-0 bg-yellow-300 font-semibold text-black text-sm px-4 py-2 rounded-b shadow-md">
    MOST POPULAR
  </div>
            <h3 className="text-center font-sans text-white  text-2xl font-semibold mb-5">PREMIUM</h3>
            <p className="text-center text-2xl font-mono font-bold mb-3 text-white ">$ 129</p>
            <p className="text-center text-xl  font-semibold text-white ">per organization / month 
              billed annually</p>
              <div className='mt-6'>
                  <button className='bg-[#FFE4DE] px-18 border border-[#D32C3E] py-3 text-xl rounded font-bold hover:bg-[#D32C3E] hover:text-white text-[#D32C3E] mb-8'>  Get Started</button>
                </div>
       ...
       <div className="shadow-2xl w-full h-full p-10 ">
  ...
  <div className={`w-full p-10 h-full rounded mt-10 ${dark ? "text-black" : "text-black"}`}>
    <h3 className="text-center text-2xl font-semibold mb-5">FREE</h3>
  ...
  <div className="w-full p-10 h-full">
    <div className="mt-25">
      <button className="bg-[#FFE4DE] px-18 border border-[#D32C3E] py-3 text-xl rounded font-bold 
