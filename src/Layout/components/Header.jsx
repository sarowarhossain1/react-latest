    ...
    <div>
      ...
      >
        <div className="flex items-center">
          <img src={SHUNNOIT} className="w-20 h-10 object-contain" alt="logo" />
        </div>
        ...
        <div className="hidden md:flex items-center space-x-4 relative">
          ...
          <div className="relative">
            ...
            {openProfile && (
              <div
                className={`absolute right-0 mt-2 w-44 bg-white dark:bg-gray-800 border rounded-lg shadow-lg z-50`}
              >
        ...
        {openMenu && (
          <div
            className={`absolute top-16 left-0 w-full px-6 py-4 md:hidden shadow-md 
            ${
          ...
          >
            <div className="flex flex-col space-y-4 text-base font-medium">
              ...
              <div className="relative">
                ...
                {openProfile && (
                  <div
                    className={`absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 border rounded-lg shadow-lg z-50`}
                  >
                    <button className="flex items-center gap-2 w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">
                      <LogIn size={16} /> Login
                    </button>
