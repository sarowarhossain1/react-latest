...
//           <div className="mx-20">
//             <div className="mt-40">
//               <h2 className={`text-5xl font-bold mb-4 text-[#212529] ${dark ? "text-white": "text-black"}`}>
...
//             <p className={`text-xl font-sans  text-[#212529] ${dark ? "text-white": "text-black"}`}>
...
//               <button className="bg-blue-400 px-7 py-2 rounded-4xl text-xl text-white font-bold cursor-pointer">
//                 লগইন
//               </button>

//               <button className="bg-pink-600 px-7 py-2 rounded-4xl text-xl text-white font-bold cursor-pointer">
//                 রেজিস্ট্রেশন
//               </button>
//             </div>
//           </div>
